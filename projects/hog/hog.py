...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    score_cube_str = str(score**3)
    total = 0
    for i in range(len(score_cube_str)):
        if i % 2 == 0:
            total += int(score_cube_str[i])
        else:
            total -= int(score_cube_str[i])
    return abs(total) + 1
    # END PROBLEM 2
...
def is_swap(player_score, opponent_score):
    ...
    power_str = str(3**sum_scores)
    if len(power_str) == 1:
        return True 
    elif power_str[0] == power_str[-1]:
        return True 
    else:
        return False 
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while (score0 < goal and score1 < goal):
        if who == 0:
            ...
            if abs(num_rolls - prev_score0) == 2 and feral_hogs:
                score0 += 3 
            
            if is_swap(score0, score1):
                score0, score1 = score1, score0
            
            prev_score0 = turn_score 
            ...
            if abs(num_rolls - prev_score1) == 2 and feral_hogs:
                score1 += 3 

            if is_swap(score1, score0):
                score0, score1 = score1, score0
            
            prev_score1 = turn_score

        say = say(score0, score1) # call the say function and store its return value (to be called in the next iteration and so on)
        who = other(who)
        # 
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    for num_roll in range(1, 11):
        average_score = averaged_dice(num_roll, dice)
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if (100 - score) < 30:
        ...
        if choice == 0:
            return swap_strategy(score, opponent_score, num_rolls=1)
        return choice 
